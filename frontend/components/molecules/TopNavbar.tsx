...
export function TopNavbar() {
  ...
  return (
    <header
      className={`fixed left-0 right-0 top-0 z-50 flex h-16 items-center justify-between px-4 md:px-6 transition-all duration-100 ease-in-out
        ${scrolled ? 'bg-guco-900/80 backdrop-blur-sm shadow-lg' : 'bg-transparent'}
      `}
    >
